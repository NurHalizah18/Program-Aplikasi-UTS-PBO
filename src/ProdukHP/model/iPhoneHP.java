 ...
 * @author NurHalizah
 */
public class iPhoneHP extends Produk_HandPhone{
    private String RAM;
    private String baterai;
    private String ukuranlayar;
    
    public iPhoneHP (String namaHP, String jenis, double harga, String RAM, String baterai, String ukuranlayar){
    ...
    public iPhoneHP (String RAM, String baterai, String ukuranlayar){
        this.RAM = RAM;
        this.baterai = baterai;
        this.ukuranlayar = ukuranlayar;
    }
