 ...
 * @author NurHalizah
 */
public class RedmiHP extends Produk_HandPhone{
    private String RAM;
    private String baterai;
    private String ukuranlayar;
    
    public RedmiHP (String namaHP, String jenis, double harga, String RAM, String baterai, String ukuranlayar){
    ...
    public RedmiHP (String RAM, String baterai, String ukuranlayar){
        this.RAM = RAM;
        this.baterai = baterai;
        this.ukuranlayar = ukuranlayar;
    }
